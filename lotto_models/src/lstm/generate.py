...
from lotto_models.lstm.lotto_lstm import create_model, LottoLSTM


def load_model(model_path: str = "lotto_models/lstm/lotto_model.pt") -> LottoLSTM:
    """저장된 모델 로드"""
...
def main():
    ...
    # 모델 로드
    model_path = Path("lotto_models/lstm/lotto_model.pt")
